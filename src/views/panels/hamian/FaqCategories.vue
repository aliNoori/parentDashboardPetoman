  ...
  <div class="p-6">
    ...
    <div class="sticky top-0 lg:top-[73px] bg-gray-50 z-30 -mx-6 px-6 py-4 mb-2 border-b border-gray-200">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-2xl font-bold text-gray-900">دسته‌بندی‌های سوالات متداول</h2>
          <p class="text-gray-600 mt-1">مدیریت دسته‌بندی‌ها و سازماندهی سوالات</p>
        </div>
        <button
          @click="$emit('navigate', 'faqs')"
      ...
      <div class="bg-white p-4 rounded-lg border border-gray-200">
        <div class="flex items-center justify-between">
          ...
          <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
            <i class="ti ti-message-question text-green-600 text-xl"></i>
          </div>
        </div>
      </div>
        ...
        <table class="w-full">
          <thead class="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th class="px-4 py-3 text-right text-xs font-medium text-gray-600">تعداد سوالات</th>
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            >
              ...
              <td class="px-4 py-3">
                <span class="text-sm text-gray-600">{{ getCategoryCount(category.slug) }} سوال</span>
              </td>
              <td class="px-4 py-3">
...
const totalFaqs = computed(() => faqStore.faqs.length)
const lastUpdate = computed(() => {
  //const faqs = computed(()=>faqStore.faqs)
  //if (!faqs.value || faqs.value.length === 0) return 'هیچ سوالی وجود ندارد'
...
const addCategory = async () => {
  if (!newCategory.value.slug.trim() || !newCategory.value.slug.trim()) return
...
const deleteCategory = async (id) => {
  ...
  if (count > 0) {
    alert(`این دسته‌بندی دارای ${count} سوال است و قابل حذف نیست.`)
    return
  }
