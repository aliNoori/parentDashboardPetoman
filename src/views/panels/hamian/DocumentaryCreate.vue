<template>
  <div class="p-6">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div class="bg-white p-6 rounded-lg border border-gray-200">
        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
          <i class="ti ti-tags text-rose-600"></i>
          برچسب‌ها و تاریخ
        </h3>
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-1">برچسب‌ها به بهبود جستجو و دسته‌بندی کمک می‌کنند</p>
          </div>

          <!-- Publish Date -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">
              تاریخ انتشار <span class="text-red-500">*</span>
            </label>
            <input
