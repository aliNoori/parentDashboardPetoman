  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      <div>
        ...
        <p class="text-gray-600 mt-1">ویرایش و به‌روزرسانی نوشته موجود</p>
      </div>
...
const publishPost = async () => {
  ...
  try {
    await postStore.updatePost(form.id,form)
...
const loadPostData = (posts) => {
  // Simulate loading post data based on stored data or ID
