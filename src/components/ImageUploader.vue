  <template>
    <div class="flex flex-col items-center">
      ...
      <div :class="['relative', wide ? 'w-full h-32 rounded-lg' : 'w-28 h-28 rounded-full']">
        ...
        <div
          :class="[
            'w-full h-full bg-gray-100 border border-gray-300 flex items-center justify-center transition overflow-hidden',
        ...
        >
          ...
          <template v-else>
            <div class="flex flex-col items-center justify-center text-center px-1">
              <i :class="['text-2xl text-gray-400', wide ? 'ti ti-photo' : 'ti ti-user']"></i>
        ...
        <button
          v-if="image && !disabled"
          type="button"
          class="absolute -top-0 right-2 w-6 h-6 bg-white border border-gray-300 text-gray-600 rounded-full flex items-center justify-center hover:bg-red-500 hover:text-white transition text-xs shadow"
